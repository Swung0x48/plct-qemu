                           ...
                           uint64_t rs3, int flags)
{
    ...
    float32 frs1 = ext_zfinx ? (float32)rs1 : check_nanbox_s(rs1);
    float32 frs2 = ext_zfinx ? (float32)rs2 : check_nanbox_s(rs2);
    float32 frs3 = ext_zfinx ? (float32)rs3 : check_nanbox_s(rs3);
